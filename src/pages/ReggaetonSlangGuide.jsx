    ...
    <BlogLayout title="Reggaeton Slang & Spanish Curse Words — Ritmo" badge="Lyrics guide">
      ...
      <JsonLd
        ...
        data={{
          ...
          '@type': 'DefinedTermSet',
          name: 'Reggaeton Slang Dictionary',
          description: 'Urban Spanish slang from reggaeton, Latin trap, and dembow lyrics.',
          hasDefinedTerm: SLANG.map((s) => ({
            '@type': 'DefinedTerm',
            name: s.term,
            description: s.contextual,
          })),
        }}
      />
